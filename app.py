...
# Store uploaded file as bytes in session state to avoid re-processing
...
if uploaded_file is not None:
    st.session_state.data_bytes = uploaded_file.read()

if st.session_state.data_bytes:
    data_io = BytesIO(st.session_state.data_bytes)
